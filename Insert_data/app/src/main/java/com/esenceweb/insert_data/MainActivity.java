package com.esenceweb.insert_data;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Create button, EditText, RequestQueue, String, ProgressDialog and HttpUrl , button objects
    ...
    String HttpUrl = "http://192.168.1.100/php_request/insert_record.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InsertButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Calling RequestQueue to call the stringRequest method
